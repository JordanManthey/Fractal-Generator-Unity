...
public class Fractal : MonoBehaviour {
	...
	void Start () {
        ...
        Mesh[] meshes = new Mesh[] { mesh, mesh1, mesh2, mesh3 };
        Random rnd = new Random();
        int randomIndex = Random.Range(0, 3);
        //mesh = meshes[randomIndex];
	...
	private void Initialize(Fractal parent, int childIndex) {
		...
		transform.localPosition = childDirections[childIndex]; // YOUR CHANGE HERE
	...
	private IEnumerator CreateChildren () {
		...
		for (int i = 0; i < childDirections.Length; i++) {
            ...
            // YOUR CODE HERE
            // GameObject child = new GameObject("c" + i);
            Fractal child = new GameObject("c" + i).AddComponent<Fractal>();
            child.Initialize(this, i);
